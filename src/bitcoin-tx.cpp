...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " motherofweeddaycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  motherofweeddaycoin-tx [options] <hex-tx> [commands]  Update hex-encoded motherofweeddaycoin transaction\n" +
            "or:     motherofweeddaycoin-tx [options] -create [commands]   Create hex-encoded motherofweeddaycoin transaction\n" +
            "\n";
