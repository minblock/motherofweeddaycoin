# Support for Output Descriptors in Motherofweeddaycoin Core

Since Motherofweeddaycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Motherofweeddaycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Motherofweeddaycoin Core wallets, a convenience function `combo` is
