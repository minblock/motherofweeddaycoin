...
"""Verify that starting motherofweeddaycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start motherofweeddaycoin with -h for help text")
        ...
        self.log.info("Start motherofweeddaycoin with -version for version information")
        ...
        self.log.info("Start motherofweeddaycoind with -fakearg to make sure it does not start")
